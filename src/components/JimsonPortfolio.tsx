      ...
      <div className="jp-shell">
        ...
        <section className="jp-section" id="projects">
          ...
          <Reveal className="jp-project-heading">
            ...
            <p>Welcome to this section, you can explore some sort of my web projects here. I chose 4 projects to showcase and you can explore it if you want to.</p>
          </Reveal>
